...
export const LaptopWifiIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 12h.01" /><path d="M9 10a3.5 3.5 0 0 1 6 0" />
  </svg>
);
...
export const LaptopEthIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="4" width="18" height="12" rx="2" /><path d="M2 20h20" />
    <path d="M9 9v2" /><path d="M12 9v2" /><path d="M15 9v2" />
  </svg>
);
...
export const WebShellIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M6 12l3 3-3 3" /><line x1="12" y1="18" x2="18" y2="18" />
  </svg>
);
...
export const TerminalIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M6 9l3 3-3 3" /><line x1="12" y1="15" x2="18" y2="15" />
  </svg>
);
